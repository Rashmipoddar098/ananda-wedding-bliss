...
const HeroSection = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative min-h-fit sm:min-h-screen flex items-center justify-center px-2 py-6 sm:py-20 overflow-hidden"
    >
      ...
      >
        ...
        <motion.div
          ...
          className="z-10 mb-1 sm:mb-2 mt-4 sm:mt-7"
        >
          <motion.p
