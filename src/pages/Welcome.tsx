...
const Welcome = () => {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center gradient-wedding overflow-hidden px-4">
      ...
      >
        <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold text-primary tracking-wide">
          Ananya
        </h1>
        <p className="font-script text-3xl md:text-4xl text-gold my-2 md:my-4">
          weds
        </p>
        <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold text-primary tracking-wide">
          Rahul
